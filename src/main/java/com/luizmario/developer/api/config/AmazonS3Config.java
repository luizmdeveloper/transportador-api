package com.luizmario.developer.api.config;
...
public class AmazonS3Config {
	...
	public AmazonS3 amazonS3() {
		...
		if (!amazonS3.doesBucketExistV2(property.getS3().getBucket())) {
			...
			BucketLifecycleConfiguration.Rule ruleExpiration = new BucketLifecycleConfiguration.Rule()
			...
			BucketLifecycleConfiguration configuration = new BucketLifecycleConfiguration().withRules(ruleExpiration);
